...
const sections = [
  ...
  {
    page: 'home', key: 'brand-story', type: 'story', eyebrow: 'Why Majestic Nailbox',
  ...
  { page: 'blog', key: 'hero', type: 'hero', eyebrow: 'Majestic Nailbox journal', title: 'Ideas for better nail days.', subtitle: 'Application guides, sizing advice, care tips, and fresh inspiration from our Ontario studio.', order: 10 },
...
const settings = {
  ...
  seo_description: 'Majestic Nailbox creates handcrafted press-on nails in Ontario for reusable, salon-quality wear.',
